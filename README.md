...
התוכנית ממומשת כמשחק אינטרקטיבי. פעולות המשחק מתבצעות בעזרת קלט מהמשתמש. בתוכנית קיימת מחלקה UI שהיא מחלקה אבסטרקטית לממשק משתמש למשחק. המחלקה Board מממשת את המחלקה UI כממשק משתמש מבוסס טקסט.
![Screenshot](/art/screenshot.png?raw=true "screen shot")
